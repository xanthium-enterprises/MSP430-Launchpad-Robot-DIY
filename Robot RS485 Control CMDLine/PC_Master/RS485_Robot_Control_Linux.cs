...
//------------------------------------------------------------------------------------------------------------//
//              Program to Control a MSP430 based Robot using RS485 Protocol (Linux)                          //
//------------------------------------------------------------------------------------------------------------//
...
namespace MSP430_Robot_Control
{
	class Menu
	{
		...
		static void ConfigureSerial(SerialPort Serial,string Name)
		{
			...
			Serial.PortName = "/dev/" + Name;    // Assign the COM port number,so name becomes /dev/ttyUSB0 or /dev/ttyS1
